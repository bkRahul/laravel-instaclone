    ...
    <div class="row mt-5 profile">
        <div class="col-md-4">
            <div class="profile__dp text-center">
                <img src="/assets/dp.jpg" alt="Photo by Muaawiyah Dadabhay on Unsplash" class="rounded-circle">
        ...
        <div class="col-md-8">
            <div class="profile__section">
                <div class="prof__head"><h1 class="prof__title">{{ $user->username }}</h1>@can('update', $user->profile)<span class="add__post"><a href="/p/create" class="btn btn-primary">Add Post</a></span>@endcan</div>   
                @can('update', $user->profile)<div class="prof__edit"><a href="/profile/{{ $user->id }}/edit">Edit Profile</a></div>@endcan
                <div class="prof__status"><ul><li><b>{{ $user->posts->count() }}</b> posts</li><li><b>23.8k</b> followers</li><li><b>214</b> following</li></ul></div>   
